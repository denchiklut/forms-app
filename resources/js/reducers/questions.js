...
export default function (state = [], action = {}) {
    switch (action.type) {
        ...
        case UPDATE_QUESTION: return state.map((question) => question._id === action.payload._id ? {...question, name: action.payload.name, webName: action.payload.webName}:question)
